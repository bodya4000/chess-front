...
const DefaultChessBoard: FC<DefaultChessBoardProps> = memo(
	...
	(prevProps, nextProps) => deepEqual(prevProps.cells, nextProps.cells) && deepEqual(prevProps.highlightedMoves, nextProps.highlightedMoves) && prevProps.onCellClick === nextProps.onCellClick && prevProps.cellSize === nextProps.cellSize
);
